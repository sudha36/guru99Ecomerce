...
public class EmailUtil {
	...
	private static final String SMTP_HOST_NAME = "chittisudha@gmail.com";
	private static final String SMTP_AUTH_USER = "chittisudha";
	private static final String SMTP_AUTH_PWD = "chittisudha75";

	private static final String emailMsgTxt = "Hi";
	private static final String emailSubjectTxt = "Orders List in CSV formatted file";
	private static final String emailFromAddress = "chittisudha@gmail.com";

	// Add List of Email address to who email needs to be sent to
	private static final String[] emailList = { "shirisha_21@outlook.com", "madamrajuk@gmail.com" };
